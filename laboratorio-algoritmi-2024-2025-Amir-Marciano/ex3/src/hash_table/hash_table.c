...
HashTable* hash_table_create(int (*compare)(const void*, const void*), unsigned long (*hash)(const void*), size_t initial_bucket_count) {
...
void hash_table_put(HashTable* table, const void* key, const void* value) {
    ...
    table->buckets = realloc(table->buckets, sizeof(HashNode*) * (table->bucket_count + 1));
